 ...
 * 
 * Alle funktionen sind Thread-sicher. runUpdates iteriert über eine Kopie der
 * Liste.
 * 
 * @author Felix Treede
 * 
...
public class UpdateManager {
	...
	/**
	 * Ruft auf jedes registrierte <code>Updatable</code>-Objekt die
	 * <code>update()</code>-Methode auf, wenn das jeweilige Dirty-Flag gesetzt
	 * ist.
	 * 
	 ...
	 * @param e das <code>Updatable</code>-Objekt
	 */
